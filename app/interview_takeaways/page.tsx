			...
			<div className="flex flex-col bg-gradient-to-b from-nice-yellow-200 to-nice-yellow-300 rounded-lg mt-0 w-screen-4 flex-grow mx-4">
				...
				<div className="flex flex-row">
					...
					<div className="flex-grow flex-auto bg-nice-green-400 rounded-lg mx-4 mt-2 mb-4">
						<p className="text-black text-left text-xl font-semibold mx-4 mt-4 leading-loose">
