                ...
                <div className="flex flex-row">
                    <div className="flex-grow flex-auto bg-nice-purple-400 rounded-lg mx-4 mt-4 mb-2">
                        <p className="text-black text-left text-[29.5px] font-semibold mx-4 my-4 indent-6 leading-loose">
                            ...
                            various <a className="font-extrabold text-nice-blue-600">proteins</a> sent to the rough ER. 
                            The <a className="font-extrabold text-nice-yellow-500">smooth endoplasmic reticulum</a> is located next to the 
