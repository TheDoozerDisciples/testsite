  ...
  return (
    <main>
      <div className="rounded-lg bg-gradient-to-r from-blue-600 to-blue-400 p-7 mx-4 mb-2 mt-4">
        <h1 className="text-gray-200 text-center text-6xl font-black">Mitochondria</h1>
        <h2 className="text-gray-200 text-center text-3xl font-bold">The Powerhouse of the Cell</h2>
      </div>
