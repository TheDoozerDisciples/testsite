	...
	return (
		<main className={`${futura.className} flex flex-col h-screen`}>
			<div className="rounded-lg bg-gradient-to-r from-nice-blue-600 to-nice-blue-500 p-7 mx-4 mb-2 mt-4">
				<Link href="/navigation" className="absolute top-2 left-2 rounded-lg bg-grey text-nice-purple-600 text-6xl object-top-left border-solid border-nice-yellow-300 border-2">Navigation</Link>
