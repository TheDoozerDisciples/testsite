  ...
  return (
    <main>
      ...
      <div className="flex bg-gradient-to-b from-emerald-300 to-emerald-400 rounded-lg mt-0 w-screen-4 flex-col h-screen mx-4">
        <p className="text-white text-left text-2xl font-semibold w-7/12">WoW! FIRE IN THE HOLE!!!! GOOGLE EN PASSANT!!! SILKSONG COMES OUT TOMORROW FR!!! BRO SLAY THE SPIRE II IS IN 2025 ISTG 2025 HAS GOT TO BE THE BEST YEAR EVER JUST FOR THAT...</p>
      </div>
    </main>
  );
}
