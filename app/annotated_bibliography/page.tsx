			...
			<div className="grid grid-cols-1 grid-rows-1 gap-0 bg-gradient-to-b from-nice-blue-200 to-nice-blue-300 rounded-lg mt-0 w-screen-4 flex-grow mx-4">
				<div className="flex flex-row">
					<div className="basis-6/12 bg-nice-blue-500 rounded-lg mx-4 mt-4 mb-2"> {/*Sources #1-#10*/}
						<div className="text-black text-left text-s mx-4 my-2 flex flex-col leading-loose">
							<div className="my-2">{/*Source #1*/}
								...
								<p className="indent-6 text-s">
									- We used this source because it tells us about chloroplast</p><p className="indent-6 text-s">
							...
							<div className="my-2">{/*Source #2*/}
								...
								<p className="indent-6 text-s">
									- We used this source because it tells us about mitochondria</p><p className="indent-6 text-s">
									- This is a reliable source because it's from EBSCOhost
								</p>
							</div>
							<div className="my-2">{/*Source #3*/}
								...
								<p className="indent-6 text-s">
									- We used this source because it tells us about the golgi apparatus</p><p className="indent-6 text-s">
									- This is a reliable source because it's from EBSCOhost
								</p>
							</div>
							<div className="my-2">{/*Source #4*/}
								...
								<p className="indent-6 text-s">
									- We used this source because it tells us about ribosomes</p><p className="indent-6 text-s">
									- This is a reliable source because it's from EBSCOhost
								</p>
							</div>
							<div className="my-2">{/*Source #5*/}
								...
								<p className="indent-6 text-s">
									- We used this source because it tells us about vacuoles</p><p className="indent-6 text-s">
									- This is a reliable source because it's from EBSCOhost
								</p>
							</div>
							<div className="my-2">{/*Source #6*/}
								...
								<p className="indent-6 text-s">
									- We used this source because it tells us about cells in general</p><p className="indent-6 text-s">
									- This is a reliable source because it's from EBSCOhost
								</p>
							</div>
							<div className="my-2">{/*Source #7*/}
								...
								<p className="indent-6 text-s">
									- We used this source because it tells us about cell walls and provides a great picture for our project</p><p className="indent-6 text-s">
							...
							<div className="my-2">{/*Source #8*/}
								...
								<p className="indent-6 text-s">
									- We used this source because it tells us about the nucleus</p><p className="indent-6 text-s">
							...
							<div className="my-2">{/*Source #10*/}
								...
								<p className="indent-6 text-s">
									- We used this source because it tells us about the endoplasmic reticulum</p><p className="indent-6 text-s">
									- This is a reliable source because it’s from Britannica, which is a well-known source that is fact-checked by experts.
								</p>
							</div>
						</div>
					...
					<div className="basis-6/12 bg-nice-blue-500 rounded-lg mx-4 mt-4 mb-2"> {/*Sources #11-#20*/}
						<div className="text-black text-left text-s mx-4 my-2 flex flex-col leading-loose">
							<div className="my-2">{/*Source #11*/}
								...
								<p className="indent-6 text-s">
									- We used this source because it tells us about plant cells</p><p className="indent-6 text-s">
									- This is a reliable source because it’s from Britannica, which is a well-known source that is fact-checked by experts.
								</p>
							</div>
							<div className="my-2">{/*Source #12*/}
								...
								<p className="indent-6 text-s">
									- We used this source because it tells us about the cell wall</p><p className="indent-6 text-s">
									- This is a reliable source because it’s from Britannica, which is a well-known source that is fact-checked by experts.
								</p>
							</div>
							<div className="my-2">{/*Source #13*/}
								...
								<p className="indent-6 text-s">
									- We used this source because it tells us about the cytoplasm</p><p className="indent-6 text-s">
									- This is a reliable source because it’s from Britannica, which is a well-known source that is fact-checked by experts.
								</p>
							</div>
							<div className="my-2">{/*Source #14*/}
								...
								<p className="indent-6 text-s">
									- We used this source because it tells us about the chloroplast</p><p className="indent-6 text-s">
									- This is a reliable source because it’s from Britannica, which is a well-known source that is fact-checked by experts.
								</p>
							</div>
							<div className="my-2">{/*Source #15*/}
								...
								<p className="indent-6 text-s">
									- We used this source because it tells us about the nucleolus</p><p className="indent-6 text-s">
									- This is a reliable source because it’s from Britannica, which is a well-known source that is fact-checked by experts.
								</p>
							</div>
							<div className="my-2">{/*Source #16*/}
								...
								<p className="indent-6 text-s">
									- We used this source because it tells us basic information about plants</p><p className="indent-6 text-s">
							...
							<div className="my-2">{/*Source #17*/}
								...
								<p className="indent-6 text-s">
									- We used this source because it tells us about the cell membrane</p><p className="indent-6 text-s">
									- This is a reliable source because it’s from Britannica, which is a well-known source that is fact-checked by experts.
								</p>
							</div>
							<div className="my-2">{/*Source #18*/}
								...
								<p className="indent-6 text-s">
									- Used for lots of general information about plant cells and their parts</p><p className="indent-6 text-s">
							...
							<div className="my-2">{/*Source #19*/}
								...
								<p className="indent-6 text-s">
									- Used for information about the Golgi apparatus</p><p className="indent-6 text-s">
									- This is a reliable source because it’s from Britannica, which is a well-known source that is fact-checked by experts.
								</p>
							</div>
							<div className="my-2">{/*Source #20*/}
								...
								<p className="indent-6 text-s">
									- [Why we used this source]</p><p className="indent-6 text-s">
