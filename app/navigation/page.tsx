...
export default function Home() {
	return (
		<main className={`${futura.className} flex flex-col h-screen`}>
			...
			<div className="gap-0 bg-gradient-to-b from-nice-blue-200 to-nice-blue-300 rounded-lg mt-0 w-screen-4 flex-grow mx-4">
				<div className="flex flex-row">
					<div className="flex-grow flex-auto bg-nice-blue-500 rounded-lg mx-4 mt-4 mb-2">
						<p className="text-black text-left text-2xl font-semibold mt-4 mb-2 mx-4 leading-loose">
							<Link href="/">Home Page/Default</Link>
						</p>
                        <p className="text-black text-left text-2xl font-semibold mt-2 mb-2 mx-4 leading-loose">
